...
account_label = tk.Label(root, bg="lightblue", text='Account Number:')
account_label.pack()

account_number_entry = tk.Entry(root)
account_number_entry.pack()

pin_label = tk.Label(root, bg="lightblue", text='PIN:')
pin_label.pack()

pin_entry = tk.Entry(root, show='*')
pin_entry.pack()

check_balance_button = tk.Button(root, text='Check Balance', bg="lightblue", command=check_balance)
check_balance_button.pack()

transaction_label = tk.Label(root,bg="lightblue", text='Transaction Amount:')
transaction_label.pack()

amount_entry = tk.Entry(root)
amount_entry.pack()

withdraw_button = tk.Button(root, text='Withdraw', bg="lightblue", command=withdraw)
withdraw_button.pack()

deposit_button = tk.Button(root, text='Deposit', bg="lightblue", command=deposit)
deposit_button.pack()
